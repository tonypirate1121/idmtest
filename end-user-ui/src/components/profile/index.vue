            ...
            <b-col class="detailsCol" lg="8">
                <b-tabs>
                    <b-tab :title="$t('pages.profile.settings')" active>
                        ...
                        <!--<fr-show-personal-info v-if="$root.userStore.state.adminUser === true" ></fr-show-personal-info>-->
                    </b-tab>
                </b-tabs>
            </b-col>
        </b-row>
...
<script>
    ...
    import ShowPersonalInfo from '@/components/profile/ShowpersonalInfo';
    ...
    export default {
        ...
        components: {
            ...
            'fr-show-personal-info': ShowPersonalInfo
        },
        mounted () {
            if (this.openProfile) {
