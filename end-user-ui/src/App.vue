        ...
        <div id="wrapper" :class="[{'toggled': toggled && !this.$route.meta.hideToolbar}]">
            <div id="appSidebarWrapper" v-if="!this.$route.meta.hideToolbar && this.$root.userStore.state.userId !== null">
                <ul class="sidebar-nav">
                    ...
                    <li>
                        <router-link v-if="$root.userStore.state.adminUser === true" :to="{ name: 'Manageuser'}"><i class="fa fa-fw mr-3 fa-user-md"></i><span class="sidebar-item-text">{{$t('pages.app.manageuser')}}</span></router-link>
                    </li>
